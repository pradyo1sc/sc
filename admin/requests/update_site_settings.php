...
if (isset($_POST['update_site_settings']) && isset($_POST['keep_blank']) && empty($_POST['keep_blank']) && $logged_in == true) {
    ...
    if (isset($_POST['friends']) && !empty($_POST['site_name']) && !empty($_POST['site_title']) && !empty($_POST['site_email']) && isset($_POST['email_verification']) && isset($_POST['chat']) && isset($_POST['captcha']) && isset($_POST['language']) && isset($_POST['smooth_links']) && isset($_POST['censored_words'])) {
        $friends = FA_secureEncode($_POST['friends']);
        $site_name = FA_secureEncode($_POST['site_name']);
        $site_title = FA_secureEncode($_POST['site_title']);
        $email = FA_secureEncode($_POST['site_email']);
        $email_verification = FA_secureEncode($_POST['email_verification']);
        $chat = FA_secureEncode($_POST['chat']);
        $captcha = FA_secureEncode($_POST['captcha']);
        $language = FA_secureEncode($_POST['language']);
        $smooth_links = FA_secureEncode($_POST['smooth_links']);
