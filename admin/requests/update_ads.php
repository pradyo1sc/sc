...
if (isset($_POST['update_ad_codes']) && isset($_POST['keep_blank']) && empty($_POST['keep_blank']) && $logged_in == true) {
    ...
    $file_content = '<?php
$config[\'ad_place_home\'] = \'' . $ad_place_home . '\';
$config[\'ad_place_messages\'] = \'' . $ad_place_messages . '\';
$config[\'ad_place_timeline\'] = \'' . $ad_place_timeline . '\';
$config[\'ad_place_hashtag\'] = \'' . $ad_place_hashtag . '\';
$config[\'ad_place_search\'] = \'' . $ad_place_search . '\';
';
        
    $process = file_put_contents('../assets/settings/ads.php', $file_content);
